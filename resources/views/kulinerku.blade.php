        ...
        <div class="container">
            ...
            <div class="row isotope-grid">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                    ...
                    <div class="block2">
                        <div class="block2-pic hov-img0">
                            <a href="/kuliner1/{{$kuliner['id_kuliner']}}">
                        ...
                        <div class="block2-txt flex-w flex-t p-t-14">
                            <div class="block2-txt-child1 flex-col-l ">
                                ...
                                <span class="stext-105 cl3">
                                    {{$kuliner['jenis_makanan']}}
                                </span>
                                <input id="input-1" name="input-1" class="rating rating-loading" data-min="0" data-max="5" data-step="0.1" value="{{ $kuliner['post']->averageRating }}" data-size="xs" disabled="">
                            </div>

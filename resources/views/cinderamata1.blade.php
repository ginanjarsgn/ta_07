                            ...
                            <div class="wrapper row">
                                ...
                                <div class="details col-md-6">
                                    ...
                                    <div class="rating">
                                        ...
                                        <input type="hidden" name="id2" value="{{$cinderamata->id_cinderamata}}">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        @csrf
    <input type="hidden" name="id" value="{{$cinderamata->id_cinderamata}}">
  <div class="form-group">
    <input type="hidden" name="jenis" value="cinderamata">

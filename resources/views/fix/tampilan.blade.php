...
<!--===============================================================================================-->  
    ...
    <link rel="stylesheet" href="{{ asset('gaya/assets/vendor/linearicons/style.css') }}">
            <link rel="stylesheet" href="{{ asset('gaya/assets/vendor/chartist/css/chartist-custom.css') }}">
    
    <!-- MAIN CSS -->
    <link rel="stylesheet" href="{{ asset('gaya/assets/css/main.css') }}">

    <!-- FOR DEMO PURPOSES ONLY. You should remove this in your project -->
    <link rel="stylesheet" href="{{ asset('gaya/assets/css/demo.css') }}">
    ...
    <link rel="icon" type="image/png" sizes="96x96" href="{{ asset('gaya/assets/img/favicon.png') }}">

    <link rel="icon" type="image/png" href="{{ asset('gaya/images/icons/favicon.png') }}"/>
<!--===============================================================================================-->
...
<body class="animsition">
                ...
                <nav class="limiter-menu-desktop container">
                    ...
                    <div class="menu-desktop" >
                        <ul class="main-menu" >
                            ...
                            @if(!auth()->user())
                            <li>
                             <a href="/login2" style="color:black;font-size: 20px;">Login</a>
                            </li>
                          @endif
     @if(auth()->user())
                            <li>
    <a href="{{url('/logout')}}" style="color:black;font-size: 20px; class="nav-link">
      ...
      <li style="color:blue;font-size: 20px; margin-left: 300px;">
        {{auth()->user()->email}}
      </li>
    ...
    <section class="section-slide">
        <div class="wrap-slick1">
            <div class="slick1">
                <div class="item-slick1" style="background-image: url(/style/images/dantob.jpeg);">
                ...
                <div class="item-slick1" style="background-image: url(/style/images/bulbul.jpg);">
                    <div class="container h-full">
                        <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                ...
                <div class="item-slick1" style="background-image: url(/style/images/andaliman.jpg);">
                    <div class="container h-full">
                        <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
...
<!--===============================================================================================-->
    ...
    <script src="{{ asset('gaya/assets/vendor/jquery/jquery.min.js') }}"></script>
    <script src="{{ asset('gaya/assets/vendor/bootstrap/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('gaya/assets/vendor/jquery-slimscroll/jquery.slimscroll.min.js') }}"></script>
